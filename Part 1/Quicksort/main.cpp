...
int main()
{
	...
	for (int i = 1; i <= 16; i*=2)
	{
		...
		cout << "Array of size: 1000 with " << i * 2  << "  Threads: " << timeArrayParallel1000 << "\t(" << timeArraySerial1000/timeArrayParallel1000<< "x Speedup)" <<  endl;
		...
		cout << "Array of size: 10000 with " << i * 2 << "  Threads: " << timeArrayParallel10000 << "\t(" << timeArraySerial10000/timeArrayParallel10000 << "x Speedup)" << endl;
		...
		cout << "Array of size: 100000 with " << i * 2<< "  Threads: " << timeArrayParallel100000 << "\t(" << timeArraySerial100000/timeArrayParallel100000 << "x Speedup)" << endl;

		auto startp4 = chrono::high_resolution_clock::now();
		quickSortParallelRun(array1000000, i);
		auto endp4 = chrono::high_resolution_clock::now();
		auto timeArrayParallel1000000 = chrono::duration<double>(endp4 - startp4).count();
		cout << "Array of size: 1000000 with " << i * 2 << "  Threads: " << timeArrayParallel1000000 << "\t(" << timeArraySerial1000000/timeArrayParallel1000000 << "x Speedup)\n\n";
